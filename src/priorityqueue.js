...
StablePriorityQueue.prototype.hasBetter = function(hash, priority) {
    for(var i = 0; i < this.array.length ; i++){
        if(this.array[i].hash == hash && this.array[i].priority <= priority){
            return true;
        }
    }
    return false;
...
StablePriorityQueue.prototype.clear = function () {
  this.array = [];
}
...
FastPriorityQueue.prototype.clear = function(){
  this.array = [];
}
...
FastPriorityQueue.prototype.hasBetter = function(hash, priority) {
    for(var i = 0; i < this.array.length ; i++){
        if(this.array[i].hash == hash && this.array[i].priority <= priority){
            return true;
        }
